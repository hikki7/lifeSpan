...
void setup() {
  ...
  // generaete instance of new osc to set up port 12000
  ...
  //effectSound=minim.loadSample(".mp3", 2048);
}
...
//=======================event of receive osc 
void oscEvent(OscMessage theOscMessage) {
  // if osc message is kinect
